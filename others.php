...
<div id="comment">
<left>
<h3 style="font-family:Comic Sans ms;color:blue">Please post your other issues:</h3>
<form id="comments" method="post" action="other.php" onsubmit="return validateForm()">
...
<textarea rows="5" cols="90" name="other"></textarea></left>
